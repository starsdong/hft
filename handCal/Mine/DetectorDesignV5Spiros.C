...
//#define        ParticleMass             0.938       // Mass of the test particle in GeV/c**2 
#define        Luminosity               10.e27       // Luminosity of the beam (RHIC I == 3.e27, RHIC II == 8.e27 )
#define        SigmaD                   30.0        // Size of the interaction diamond (cm) (assume 30/15 cm RHIC I/II)
...
#define        IntegrationTime          0.010       // Integration time for PXL chips (milliseconds) (eg 4.0 or 0.2)
#define        UPCBackgroundMultiplier  1.3         // Increase multiplicity in detector (0.0 to 1.0 * UPCRate ) (eg 1.0)
...
#define        EfficiencySearchFlag     0           // Define search method. ChiSquare = 1, Simple = 0.  ChiSq is better
...
#define        AvgRapidity              0.35        // Avg rapidity, MCS calc is a function of crossing angle 
...
#define        Pxl1Resolution           0.0040      // cm  40 - considering alignment, 30 x 30   micron pixels  (30 old 21 new)
#define        Pxl1ResolutionZ          0.0040      // cm  40 - considering alignment, 30 x 30   micron pixels  (30 old 21 new)

#define        Pxl2Resolution           0.0040      // cm  40 - considering alignment, 30 x 30   micron pixels  (30 old 21 new)
#define        Pxl2ResolutionZ          0.0040      // cm  40 - considering alignment, 30 x 30   micron pixels  (30 old 21 new)
...
#define        TpcResolution            0.0500      // cm  500 x 1000 microns ... Test data wants 500 or 575-625 microns 
#define        TpcResolutionZ           0.1000      // cm  500 x 1000 microns ... Based on experience with real data
...
#define        Pxl1Thickness            0.0040  // % Radiation Lengths ( Sim 0.0032 new Al 0.0037 new Cu 0.0062)  
#define        Pxl2Thickness            0.0052  // % Radiation Lengths ( Sim 0.0032 new Al 0.0037 new Cu 0.0062)
#define        BeamPipe2Thickness       0.0024  // % Radiation Lengths 
...
#define        Pxl1Radius               2.9     // cm (2.9 final 2.5  new 1.55 old) JT Test
...
void DetectorDesignV5Spiros(const double ParticleMass = 0.140) 
{
  ...
  while ( 1 ) 
      ...
      while ( 1 )
	{
	  ...
	  if ( strcmp(Detector,"quit") == 0 ) 
	    { 
	      ...
	      cout << " Start to save the output" << endl;
	      TFile *fout = new TFile("output.root","recreate");
	      if(data1) data1->Write();
	      if(data2) data2->Write();
	      if(data3) data3->Write();
	      if(data4) data4->Write();
	      if(data5) data5->Write();
	      if(data6) data6->Write();
	      if(data7) data7->Write();
	      if(data8) data8->Write();
	      fout->Close();
	...
	double r1 = 100*Radius[Pxl1Index];
	double r2 = 100*Radius[Pxl2Index];
	cout << "The hit densities on PXL1 & PXL2 are " << HitDensity(r1) << " &  " 
	     << HitDensity(r2) << " per cm**2." << endl ;
	cout << " Radius = " << r1 << " OneEvent = " << OneEventHitDensity(dNdEtaCent,r1) << " PileupMB = " << IntegratedHitDensity(dNdEtaMinB,r1) << " UPC = " << UpcHitDensity(r1) << endl;
	cout << " Radius = " << r2 << " OneEvent = " << OneEventHitDensity(dNdEtaCent,r2) << " PileupMB = " << IntegratedHitDensity(dNdEtaMinB,r2) << " UPC = " << UpcHitDensity(r2) << endl;
      }
      ...
      else 
	{
      ...
      data3 -> SetMaximum(10000.1) ;
      data3 -> SetTitle("R-#phi Pointing Resolution .vs. Pt" ) ;
      if ( Clear == 1 )
	{
	  data3 -> Draw("AC") ;
	  data3 -> GetXaxis()->SetTitle("Transverse Momentum (GeV/c)") ;
	...
	{ 
      ...
      data6 -> SetMaximum(10000.1) ;
      data6 -> SetTitle("Z Pointing Resolution .vs. Pt" ) ;
      if ( Clear == 1 )
	{
	  data6 -> Draw("AC") ;	  
	  data6 -> GetXaxis()->SetTitle("Transverse Momentum (GeV/c)") ;
...
{ 
  ...
  UPCelectrons = 16/5.1 - 1.8/5.1 * Radius/100            ;
