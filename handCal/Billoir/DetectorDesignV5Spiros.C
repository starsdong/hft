...
#define        ParticleMass             0.140       // Mass of the test particle in GeV/c**2 
...
#define        Pxl1Thickness            0.0039  // % Radiation Lengths ( Sim 0.0032 new Al 0.0037 new Cu 0.0062)  
