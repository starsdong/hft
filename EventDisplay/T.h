...
// Wed Feb  5 21:51:42 2014 by ROOT version 5.30/00
...
#include <TChain.h>
#include <TFile.h>
   const Int_t kMaxfVertices = 10;
   const Int_t kMaxfTracks = 100;
   const Int_t kMaxfHits = 1000;
   const Int_t kMaxfMatchHits = 1000;
